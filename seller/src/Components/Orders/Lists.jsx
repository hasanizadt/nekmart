                            ...
                            return (
                                <tr key={i}>
                                    ...
                                    <td className={classes}>
                                        <Typography
                                            variant="small"
                                            className={`font-semibold text-[14px] ${getColor(item.status)}`}>
                                            {item.status}
                                        </Typography>
                                    </td>
                                    <td className={`${classes}`}>
                ...
                <div className="p-3 flex gap-2 items-center">
                    ...
                    {data?.getOrdersBySeller.meta.totalPages && data.getOrdersBySeller.meta.totalPages > 1 &&
                        <div className="flex justify-end gap-2">
                            ...
                            <button
                                className={`border border-black border-solid p-1.5 rounded ${pagination >= (data?.getOrdersBySeller?.meta?.totalPages || 0) ? "opacity-40" : "opacity-100"}`}
                                disabled={pagination >= (data?.getOrdersBySeller?.meta?.totalPages || 0)}
                                onClick={() => setPagination(pagination + 1)}>
