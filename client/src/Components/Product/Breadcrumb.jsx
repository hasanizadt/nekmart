...
const Breadcrumb = () => {
    ...
    return (
        <div
            className="flex gap-5 items-center mb-5 border-b border-solid border-gray-300 py-3">
            <Breadcrumbs className="bg-white">
                <Link
                    href={`/category/${data.getProduct.category?.id}`}
                    className="text-main text-base font-light">
