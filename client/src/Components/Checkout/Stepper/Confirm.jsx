...
const Confirm = () => {
    ...
    //Urql
    const [{ error, fetching }, mutate] = useMutation(ADD_ORDER);
        ...
        <div className="grid grid-cols-12 gap-10 items-start">
            ...
            <div className="col-span-8 border border-solid border-gray-300">
                ...
                <div className="px-4 py-5">
                    ...
                    <div
                        className={`border border-solid w-max rounded-md py-3 mt-3 cursor-pointer select-none p-3 ${selected === "ssl" ? "border-main" : "border-gray-400"}`}
                        onClick={() => setSelected("ssl")}>
                ...
                <div className="px-4 py-5">
                    ...
                    <div
                        className={`border border-solid w-max rounded-md py-3 mt-3 cursor-pointer select-none p-3 ${selected === "cash" ? "border-main" : "border-gray-400"}`}
            ...
            <div className="col-span-4">
                ...
                <div className="mt-5">
                    <button
                        className={`bg-main py-2 text-center w-full rounded-md text-sm font-medium text-white relative ${!selected ? "opacity-50" : ""}`}
                        disabled={!selected}
                        onClick={onPlace}>
                        Place Order
