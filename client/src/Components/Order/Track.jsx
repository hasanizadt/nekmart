...
const Track = () => {
    ...
    const [{ data, error, fetching }, refetch] = useQuery(
        { query: GET_ORDER, variables: { trackInput: { trackId: watch().trackId } }, pause: true }
    )
    ...
    return (
        <div>
            <div
                className="w-[60%] mx-auto border border-solid border-gray-300 rounded-md py-6 px-6 text-center">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="my-5">
                        <button
                            className="text-white bg-main py-2.5 px-5 rounded-md text-sm uppercase font-semibold relative"
                            disabled={fetching}
                            type="submit">
            ...
            {(data || error) &&
                <Fragment>
                    <div
                        className="w-[60%] mx-auto border border-solid border-gray-300 rounded-md py-6 px-6 mt-6">
                        {error?.message &&
