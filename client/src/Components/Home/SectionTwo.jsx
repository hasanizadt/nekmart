...
const SectionTwo = () => {
    //Urql
    const [{ data }] = useQuery({ query: GET_SECTIONS });
    ...
    return (
        <Fragment>
            {data.getSectionProducts.length > 0 && data.getSectionProducts[3].products.length > 0 &&
                <section>
                    <Container className="py-12">
                        <Header section={data.getSectionProducts[3].section} />
                        ...
                        <div className="text-center mt-8">
                            {data.getSectionProducts[3].section.base === "category" ?
                                (<Link
                                href="/"
                                className="py-2 px-4 bg-main text-white rounded-md font-medium text-sm">
                                    View More
                                </Link>) : (
                                    <Link
                                        href="/category/shop"
            ...
            {data.getSectionProducts.length > 4 && data.getSectionProducts[4].products.length > 0 &&
                <section>
                    <Container className="py-12">
                        <Header section={data.getSectionProducts[4].section} />
                        <div className="grid grid-cols-5 gap-6 mt-12">
            ...
            }
            {
                ...
                <section>
                    <Container className="py-12">
                        <Header section={data.getSectionProducts[5].section} />
                        <div className="grid grid-cols-5 gap-6 mt-12">
