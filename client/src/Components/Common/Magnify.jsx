    ...
    return (
        <div className="relative inline-block">
            <div className="relative overflow-hidden">
                ...
                {isMagnified &&
                    <div
                        className="bg-black bg-opacity-60 rounded absolute pointer-events-none"
                        style={{ top: `${position.y - lenseSize / 2}px`, left: `${position.x - lenseSize / 2}px`, width: `${lenseSize}px`, height: `${lenseSize}px` }} />
                }
            </div>
            {isMagnified &&
                <div
                    className="absolute left-full top-0 w-[500px] h-full overflow-hidden ml-4 rounded z-30">
                    <Image
                        src={imageProps.src}
                        alt="Magnified"
                        fill
