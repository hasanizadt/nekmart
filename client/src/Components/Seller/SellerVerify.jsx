...
const SellerVerify = ({
    ...
    //Urql
    const [{ fetching, error }, mutate] = useMutation(VERIFY_SELLER_PHONE);
    ...
    return (
        <Fragment>
            <Dialog open={open} handler={() => { }} size="md">
                ...
                <div className="text-black p-6 text-center">
                    ...
                    <div className="mt-8">
                        <button
                            className="bg-main uppercase font-semibold py-2 text-white px-5 rounded-md text-sm relative"
                            type="submit"
                            disabled={fetching}
                            onClick={onSubmit}>
