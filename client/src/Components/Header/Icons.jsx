...
const Icons = () => {
    ...
    //Urql
    const [{ data: wishlist }] = useQuery({ query: GET_WISHLIST });
    const [{ data: cart }] = useQuery({ query: GET_CART });
        ...
        <div className="col-span-4">
            <ul className="flex gap-4 justify-end items-center">
                <li>
                    <Link
                        href="/flash-deals"
                        className="bg-whiter w-10 h-10 rounded-md flex justify-center items-center hover:bg-white_hover">
                ...
                <li>
                    <Link
                        ...
                        className="bg-whiter w-10 h-10 rounded-md flex justify-center items-center relative hover:bg-white_hover">
                        <Icon className="text-xl text-main" icon="ant-design:heart-filled" />
                        <p
                            className="bg-white text-[10px] w-4 h-4 flex justify-center items-center rounded-full  absolute top-0.5 right-0.5 shadow-3xl">
