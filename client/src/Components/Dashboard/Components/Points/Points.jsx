...
const Points = () => {
    ...
    //Urql
    const [{ data: userPoints }] = useQuery({ query: GET_USER_POINTS });
    const [{ data: points }] = useQuery({ query: GET_POINTS });
    const [{ data: coupon }] = useQuery({ query: GET_COUPON_CODE });
    ...
    return (
        <div>
            ...
            <div
                className="w-[43%] mx-auto text-center bg-gradient-to-br from-[#eb4786] to-[#b854a6] py-4 rounded-md text-white">
                    ...
                    <tbody>
                        {RedeemData.map((item, i) => {
                            return (
                                <Redeem
                                    item={item}
                                    userPoints={userPoints?.getUserPoints.points}
                                    key={i}
