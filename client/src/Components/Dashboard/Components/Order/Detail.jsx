...
const Detail = () => {
    ...
    const [{ data, error }, refetch] = useQuery(
        { query: GET_SINGLE_ORDER, variables: { getSingleOrderByUserId: router.query.id } }
    );
    const [{ data: cancel, error: cancelError, fetching }, mutate] = useMutation(CANCEL_ORDER);
    ...
    if (error) return (<p className="text-center mt-1 text-main font-semibold">{error.message}</p>);
    ...
    return (
        <div>
            ...
            <div
                className="py-3 px-4 flex gap-5 border border-solid border-gray-300 items-center rounded mb-6">
                ...
                <div className="border border-solid border-gray-300 rounded-md mb-6" key={i}>
                    <div className="px-3 py-2 border-b border-solid border-gray-300 flex gap-2">
                        ...
                        <button
                            ...
                            className="text-main font-semibold uppercase text-sm">
                            Cancel
                        </button>
                    </div>
                    <div className="p-5">
                        <div className="w-[70%] mx-auto my-14">
                            <Timeline current={item.status} />
                        </div>
                        <div className="mt-8">
            ...
            <div className="border border-solid border-gray-200 rounded-md mb-8">
                <h4
                    className="text-lg font-semibold px-3 py-3 border-b border-solid border-gray-200">Total Summery</h4>
                <div className="p-5">
            ...
            <div className="border border-solid border-gray-200 rounded-md mb-8">
                <h4
                    className="text-lg font-semibold px-3 py-3 border-b border-solid border-gray-200">Addresses</h4>
