                ...
                <Fragment>
                    ...
                    <ul className="flex gap-2">
                        {data?.getSiteSettings.facebook &&
                            <li>
                                <Link
                                    href={data.getSiteSettings.facebook}
                                    className="w-10 h-10 flex justify-center items-center border border-gray_whiter rounded-sm">
                        ...
                        {data?.getSiteSettings.instagram &&
                            <li>
                                <Link
                                    href={data.getSiteSettings.instagram}
                                    className="w-10 h-10 flex justify-center items-center border border-gray_whiter rounded-sm">
                        ...
                        {data?.getSiteSettings.youtube &&
                            <li>
                                <Link
                                    href={data.getSiteSettings.youtube}
                                    className="w-10 h-10 flex justify-center items-center border border-gray_whiter rounded-sm">
                        ...
                        {data?.getSiteSettings.twitter &&
                            <li>
                                <Link
                                    href={data.getSiteSettings.twitter}
                                    className="w-10 h-10 flex justify-center items-center border border-gray_whiter rounded-sm">
                        ...
                        {data?.getSiteSettings.linkedIn &&
                            <li>
                                <Link
                                    href={data.getSiteSettings.linkedIn}
                                    className="w-10 h-10 flex justify-center items-center border border-gray_whiter rounded-sm">
