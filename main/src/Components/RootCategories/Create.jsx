...
import { ADD_ROOT_CATEGORY } from "@/Urql/Query/RootCategories/root.query";
const Create = () => {
    //State
    const [notification, setNotification] = useState(false);

    //Urql
    const [{ data, error, fetching }, mutate] = useMutation(ADD_ROOT_CATEGORY);
    ...
    const onSubmit = (value) => {
        mutate({ mainCategoryInput: value }).then(() => {
    ...
    return (
        <div>
            <Notification
                ...
                {error?.message ?? data?.addMainCategory.message}
            </Notification>
