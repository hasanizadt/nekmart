...
const Edit = () => {
    ...
    //Urql
    const [{ data: categoryData }, refetch] = useQuery({ query: GET_SINGLE_MAIN_CATEGORY, variables: { getMainCategoryId: id } })
    const [{ data, error, fetching }, mutate] = useMutation(UPDATE_MAIN_CATEGORY);
