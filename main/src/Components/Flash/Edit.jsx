...
const Edit = () => {
    ...
    //Urql
    const [{ data: flashData }, refetch] = useQuery({ query: GET_SINGLE_FLASH, variables: { getFlashId: id } })
    const [{ data, error, fetching }, mutate] = useMutation(UPDATE_FLASH);
                            ...
                            <Controller
                                ...
                                render={({ field: { onChange, value } }) => (
                                    <Datepicker
                                        ...
                                        primaryColor="red"
                                        displayFormat={"DD-MM-YYYY"}
                                        minDate={new Date(watch("start")?.endDate)}
                                        customInput={
                                            <Input
                                                label="Expire date"
                                                color="red"
