...
const Edit = () => {
    ...
    //Urql
    const [{ data: shippingData }, refetch] = useQuery({ query: GET_SINGLE_SHIPPING, variables: { getShippingId: id } })
    const [{ data, error, fetching }, mutate] = useMutation(UPDATE_SHIPPINGS);
