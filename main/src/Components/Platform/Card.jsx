...
const Card = () => {
    ...
    //Urql
    const [{ data, error }, refetch] = useQuery({ query: GET_PLATFORM });
    const [{ data: addData, error: addError, fetching }, mutate] = useMutation(ADD_PLATFORM);
    ...
    const {
        ...
        defaultValues: {
            charge: data?.getPlatform.charge
        }
    })
    ...
    return (
        <div className="border border-solid border-gray-200 rounded-md">
            ...
            <div className="px-3 py-5">
                ...
                {data &&
                    <div
                        className="w-[40%] mx-auto bg-main rounded-md px-10 py-16 text-center text-white">
                ...
                <div className="text-center mt-6">
                    <button
                        ...
                        className="bg-main py-2 px-6 rounded text-white text-sm uppercase font-semibold">
