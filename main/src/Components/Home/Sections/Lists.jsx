...
const Lists = () => {
    ...
    //Urql
    const [{ data }, refetch] = useQuery({ query: GET_SECTIONS });
    const [{ data: deleteData, error, fetching }, mutate] = useMutation(DELETE_SECTION);
                            ...
                            return (
                                <tr key={i}>
                                    ...
                                    <td className={classes}>
                                        <Typography
                                            variant="small"
                                            className={`font-semibold text-[14px] capitalize ${item.publish ? "text-green-600" : "text-main"}`}>
                                    ...
                                    <td className={`${classes}`}>
                                        <div className="flex gap-3 justify-center items-center">
                                            <div>
                                                ...
                                                <Edit open={item.id === edit} onClose={() => setEdit(null)} section={item} />
                                            </div>
                                            <div>
                                                <Tooltip
