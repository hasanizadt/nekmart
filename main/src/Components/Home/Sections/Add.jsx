...
const Add = () => {
    ...
    const [{ data, error, fetching }, mutate] = useMutation(ADD_SECTION);
    const [_, refetch] = useQuery({ query: GET_SECTIONS });
            ...
            <div className="border border-solid border-gray-200 rounded-md">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-5">
                    ...
                    <div className="grid grid-cols-4 gap-2 items-start mb-7">
                        ...
                        <div className="col-span-3">
                            <Switch color="red" crossOrigin="anonymous" {...register("publish")} />
                        </div>
                    </div>
                    <div className="text-right mt-8">
                        <button
                            className="bg-main uppercase font-semibold py-3 text-white px-5 rounded-md text-sm relative"
                            type="submit"
                            disabled={fetching}>
