...
import { ADD_BANNER_ONE, GET_BANNER_ONE } from "@/Urql/Query/Home/banner-one.query";
const Add = () => {
    //State
    const [notification, setNotification] = useState(false);

    //Urql
    const [{ data, error, fetching }, mutate] = useMutation(ADD_BANNER_ONE);
    const [_, refetch] = useQuery({ query: GET_BANNER_ONE });
    ...
    return (
        <div>
            <Notification
                ...
                {error?.message ?? data?.addBannerOne.message}
            </Notification>
