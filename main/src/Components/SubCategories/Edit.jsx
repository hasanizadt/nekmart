...
const Edit = () => {
    ...
    const [{ data: categoryData }] = useQuery(
        { query: GET_CATEGORIES, variables: { searchInput: { limit: 20, page: 1, search: search } }, requestPolicy: "cache-and-network" }
    )
    const [{ data: subData }, refetch] = useQuery({ query: GET_SINGLE_SUB_CATEGORY, variables: { getSubCategoryId: id } })
    const [{ data, error, fetching }, mutate] = useMutation(UPDATE_SUB_CATEGORY);
