...
const OrderStatus = ({
    ...
    //Urql
    const [{ data, error, fetching }, mutate] = useMutation(CHANGE_ORDER_STATUS);
    const [{ data: cancel, error: cancelError, fetching: cancelFetching }, cancelMutate] = useMutation(CANCEL_ORDER);
    const [_, refetch] = useQuery({ query: GET_SINGLE_ORDER, variables: { getOrderId: router.query.id } });
    ...
    return (
        <div className="mt-8">
            ...
            <div className="border border-solid border-gray-300 px-5 pb-5 pt-5 rounded-md">
                <Select label="Select Status" color="red" onChange={(e) => setStatus(e)}>
                ...
                <div className="text-right mt-10">
                    <button
                        ...
                        onClick={onChange}
                        disabled={fetching || cancelFetching}>
