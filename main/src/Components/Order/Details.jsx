...
const Details = () => {
    ...
    //Urql
    const [{ data }] = useQuery({ query: GET_SINGLE_ORDER, variables: { getOrderId: router.query.id } });
        ...
        <div>
            ...
            {data.getOrder.sellers.map((item, i) => (
                <Package
                    ...
                    key={i}
                    totalTax={totalTax}
                    shippingFees={data.getOrder.shippingFees}
                    couponDiscount={data.getOrder.couponDiscount}
            ...
            <div className="border border-solid border-gray-200 rounded-md mb-8">
                <h4
                    className="text-lg font-semibold px-3 py-3 border-b border-solid border-gray-200">Order Notes</h4>
                <div className="p-5">
