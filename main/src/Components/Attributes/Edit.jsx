...
const Edit = () => {
    ...
    //Urql
    const [{ data: attributeData }, refetch] = useQuery({ query: GET_SINGLE_ATTRIBUTE, variables: { getAttributeId: id } })
    const [{ data, error, fetching }, mutate] = useMutation(UPDATE_ATTRIBUTE);
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-5">
                    ...
                    <div className="grid grid-cols-4 gap-2 items-start mb-7">
                        ...
                        <div className="col-span-3">
                            {fields.map((_, i) => (
                                <div key={i} className="grid grid-cols-12 gap-5">
                                    ...
                                    <div className="col-span-2 flex items-center justify-center">
                                        <button
                                            onClick={() => remove(i)}
                                            className="text-main text-sm mt-7 opacity-70 font-semibold"
                                            type="button"
                            ...
                            <div className="mt-5">
                                <button
                                    className="bg-black text-sm text-white px-5 py-2 rounded-md uppercase font-semibold"
                                    type="button"
