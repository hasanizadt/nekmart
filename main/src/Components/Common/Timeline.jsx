                ...
                <Fragment key={i}>
                    <div className="flex-1">
                        <div className="text-center">
                            <div
                                className="border border-solid border-gray-400 w-9 h-9 rounded-full mx-auto flex justify-center items-center relative bg-white">
                                ...
                                {i < data.length - 1 &&
                                    <div
                                        className="absolute left-full top-1/2 w-[105px] h-[3px] bg-gray-400 -z-10" />
                                }
                            </div>
