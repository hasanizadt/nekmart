        ...
        <Dialog
            ...
            <DialogBody className="text-black text-center py-8">
                ...
                <div className="mt-6 flex gap-5 justify-center">
                    <Button
                        color="green"
                        className="h-[36px] w-[90px] flex items-center justify-center focus:ring-0"
                        variant="outlined"
                        onClick={onClose}><span>Cancel</span></Button>
                    <Button
                        color="green"
                        className="bg-green-600 h-[36px] w-[90px] flex justify-center items-center"
