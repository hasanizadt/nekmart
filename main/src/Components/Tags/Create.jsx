...
import { CREATE_TAG } from "@/Urql/Query/Tags/tag.query";
const Create = () => {
    //State
    const [notification, setNotification] = useState(false);

    //Urql
    const [{ data, error, fetching }, mutate] = useMutation(CREATE_TAG);
    ...
    return (
        <div>
            <Notification
                ...
                {error?.message ?? data?.addTag.message}
            </Notification>
            <h6 className="font-bold text-lg mb-8">Create new tag</h6>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-5">
                    ...
                    <div className="text-right mt-8">
                        <button
                            ...
                            type="submit"
                            disabled={fetching}>
                            <span className={fetching ? "opacity-30" : "opacity-100"}>Add tag</span>
