...
const Details = ({
    ...
    //Urql
    const [{ data, error, fetching }, mutate] = useMutation(CHANGE_REFUND_STATUS);
    ...
    return (
        <Dialog
            ...
            <DialogBody className="text-black p-5 max-h-[450px] overflow-auto">
                ...
                <button
                    className="bg-main uppercase font-semibold py-2 text-white px-4 rounded-md text-sm relative w-max mt-5"
