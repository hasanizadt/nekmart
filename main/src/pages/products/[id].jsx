...
const Products = () => {
    ...
    //Urql
    const [{ error, data }] = useQuery({ query: GET_SINGLE_PRODUCT, variables: { getProductId: id } });

    if (error) return (<p className="text-center font-semibold mt-4 text-main">There is no data matched!</p>);
