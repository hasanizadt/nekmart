...
import { GET_ADMINS } from "@/Urql/Query/Authentication/user.query";

const Users = () => {
    return (
        <Layout title="User List" active="admin">
            <Add />
            <Lists />
        </Layout>
    );
...
export const getServerSideProps = async (ctx) => {
    ...
    //--//
    await client.query(GET_ADMINS, { searchInput: { page: 1, limit: 20 } }, {
        fetchOptions,
        requestPolicy: "network-only"
    }).toPromise();
