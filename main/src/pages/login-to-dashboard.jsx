...
import { ADMIN_LOGIN, GET_PROFILE } from "@/Urql/Query/Authentication/auth.query";
...
const Login = () => {
    ...
    //Urql
    const [{ error, fetching }, mutate] = useMutation(ADMIN_LOGIN);
    ...
    return (
        <Container className="!py-28">
            ...
            <div
                className="w-[35%] mx-auto shadow-3xl border border-solid border-gray-300 rounded-lg p-8">
                <div className="text-center">
                    <Image
                        ...
                        height={60}
                        className="mx-auto" />
                    <p className="text-base font-medium italic">Login to admin</p>
                </div>
